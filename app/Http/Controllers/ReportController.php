...
class ReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Kiểm tra nếu bảng report đang trống, thực hiện quét toàn bộ đơn hàng theo batch nhỏ
        if (Report::count() === 0) {
        ...
        // Truy vấn báo cáo theo ngày và gộp theo user
        $query = Report::selectRaw("
                user,
                SUM(unit_sale) as unit_sale,
        ...
        // Lấy dữ liệu ads độc lập từ bảng ads_fee theo user và date
        $reports = $query->get();
        ...
        $users = User::whereIn('id', Report::distinct()->pluck('user'))->get();
